...
from art.repair_moudle import Netsum, get_bitmap
...
if __name__ == '__main__':
    ...
    # test(lr=1e-2, net='CNN_small', repair_radius=0.1, repair_number = 100, refine_top_k= 50, 
    #      train_datasize = 10000, test_datasize = 1000, 
    #      accuracy_loss='CE')
