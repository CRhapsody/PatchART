...
def test_repaired(args: Namespace) -> float:
    ...
    for images, labels in testloader:
        ...
        with torch.no_grad():
            ...
            # _,index = ori_images_pred.topk(1, dim=1)
            # get the max index
            index = ori_images_pred.argmax(dim=1)
        ...
        repaired_net.get_bitmap_first(sample_top1=index)
    ...
    # for net in ['FNN_small']:
        ...
        # for label_repaired in [True]:
            ...
            for radius in [0.05, 0.1, 0.3]: #,0.1,0.3
                    ...
                    for repair_number in [50, 100, 200, ]:
                        # if net == 'FNN_small' and repair_number == 50  and radius == 0.05:
                        #     continue
