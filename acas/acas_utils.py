...
class AcasNetID(object):
    ...
    def __repr__(self):
        return f'AcasNetID_{self.x}_{self.y}_'
    ...
    def goal_safety_ids(cls, dom: AbsDom) -> List[AcasNetID]:
        ...
        # 1,7;1,8;1,9
        # ids = [AcasNetID(torch.tensor(1),torch.tensor(7)),AcasNetID(torch.tensor(1),torch.tensor(8)),AcasNetID(torch.tensor(1),torch.tensor(9))]
        return ids
